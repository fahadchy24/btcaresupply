...
class ProductController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('backend.product.add', compact('products', 'categories', 'subcategories', 'childcategories', 'attributes', 'brands'));
    }
    ...
    public function show($id)
    {
        ...
        return view('backend.product.view', compact('product','categories','subcategories', 'childcategories'));
    }
    ...
    {   
        ...
        return view('backend.product.edit', compact('product', 'categories', 'subcategories', 'childcategories', 'brands'));
    }
    ...
    public function destroy(Product $product, $id)
    {
        ...
        if (!is_null($product)) {
            if (file_exists('uploads/frontend/image/product/'.$dltproduct->main_image)) {
                unlink('uploads/frontend/image/product/'.$dltproduct->main_image);
            }
            if (file_exists('uploads/frontend/image/product/alternative/'.$dltproduct->product_images)) {
                unlink('uploads/frontend/image/product/alternative/'.$dltproduct->product_images);
            }
