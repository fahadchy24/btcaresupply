...
Route::prefix('/admin')->middleware('admin')->group(function(){
	...
	Route::get('product/get/subcategory/{id}', 'ProductController@getSubCat');
	Route::get('product/get/childcategory/{id}', 'ProductController@getChildCat');
	...
	Route::match(['get', 'post'], 'childcategory', 'ChildCategoryController@index')->name('child.category');
	Route::get('childcategory/edit/{id}', 'ChildCategoryController@edit')->name('edit-childcategory');
	Route::post('childcategory/update/{id}', 'ChildCategoryController@update')->name('update-childcategory');
	Route::get('childcategory/delete/{id}', 'ChildCategoryController@destroy')->name('delete-childcategory');
	Route::get('childcategory/check-slug', 'ChildCategoryController@checkSlug')->name('check.childcategory.slug');
