                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-row mt-3">
                                ...
                                <input title="Enter Cost" type="text" class="form-control" id="cost" name="cost" value="{{ $product->cost }}" autocomplete="on" >
                            </div>
                            <div class="form-row mt-3">
                                <label class="form-control-label" for="unit_per_cost">Unit Per Cost*</label>
                                <input title="Enter Unit Per Cost" type="text" class="form-control" id="unit_per_cost" name="unit_per_cost" value="{{ $product->unit_per_cost }}" autocomplete="on">
                            </div>
                            <div class="form-row mt-3">
                        ...
                        <div class="card-body">
                            <div class="form-row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-row mt-3">
                                        <label class="form-control-label" for="subcategory_id">SubCategory</label>
                                        <select class="form-control" name="subcategory_id" id="subcategory_id">
                                            <option></option>
                                            @foreach($subcategories as $row)
                                            <option {{ $row->id == $product->subcategory_id ? 'selected' :'' }} value="{{ $row->id }}">{{ $row->subcategory_name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-row mt-3">
                                        <label class="form-control-label" for="childcategory_id">Child Category</label>
                                        <select class="form-control" name="childcategory_id" id="childcategory_id">
                                            <option></option>
                                            @foreach($childcategories as $row)
                                            <option {{ $row->id == $product->childcategory_id ? 'selected' : '' }} value="{{ $row->id }}">{{ $row->childcategory_name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
...
<script>
    $(document).ready(function(){
        $('select[name="subcategory_id"]').on('change', function(){
            ...
            if(subcategory_id){
                $.ajax({
                    url:"{{ url('admin/product/get/childcategory') }}/"+subcategory_id,
                    type:"GET",
                    dataType:"json",
                    success:function(data){
                        $("#childcategory_id").empty();
