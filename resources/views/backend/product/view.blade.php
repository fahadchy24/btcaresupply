                        ...
                        <div class="form-row">
                            <div class="col-md-12">
                                <div class="form-group row">
                                    <ul>
                                        <li>
                                            <span class="badge badge-primary">{{ $product->categories->category_name }}</span>
                                            <span class="badge badge-primary">{{ $product->subcategory_id>NULL ? $product->subcategories->subcategory_name : '' }}</span>
                                            <span class="badge badge-primary">{{ $product->childcategory_id>NULL ? $product->childcategories->childcategory_name : '' }}</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
