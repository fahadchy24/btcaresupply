                    ...
                    <table class="table table-flush" style="width: 100%;" id="datatable-basic">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td> {{$loop->index+1}} </td>
                                <td>
                                    <span class="badge badge-primary">{{ $row->categories->category_name }}</span>
                                    <span class="badge badge-primary">{{ $row->subcategory_id>NULL ? $row->subcategories->subcategory_name : ''}}</span>
                                    <span class="badge badge-primary">{{ $row->childcategory_id>NULL ? $row->childcategories->childcategory_name :''}}</span>
                                </td>
                                <td>{{$row->mpn}}</td>
