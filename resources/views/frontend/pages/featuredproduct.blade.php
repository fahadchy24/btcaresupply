    ...
    <div class="row">
        ...
        <div id="content" class="col-md-9 col-sm-12">
            <div class="products-category">
                <h3 class="title-category ">All Featured Products Products</h3>
                <!-- Filters -->
                            ...
                            <div class="left-block left-b">
                                <div class="product-image-container">
                                    <a href="{{ url('/product/view/'.$row->id)}}" target="_self" title="{{ $row->product_name }}">
                                        <img src="{{ $row->main_image }}" class="img-1 img-responsive" alt="imageee"> 
                                    </a>
                                </div>
                            </div>
                            <div class="right-block right-b">
                                <div class="caption">
                                    <h4><a href="{{ url('/product/view/'.$row->id)}}" title="{{$row->product_name}}" target="_self">{{ \Illuminate\Support\Str::limit(strip_tags($row->product_name), 40)}}</a></h4>
                                    <div class="price"> <span class="price-new">{{ "$".$row->regular_price }}</span>
                                    </div>
