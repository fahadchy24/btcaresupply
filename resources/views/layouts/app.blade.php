                                                            ...
                                                            <div class="megamenuToogle-pattern">
                                                                <div class="container">
                                                                    <div> <span></span>
                                                                        <span></span>
                                                                        <span></span>
                                                                    </div> <span class="title-mega">All Categories</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                                                            ...
                                                                                            <div class="col-md-12 static-menu">
                                                                                                <div class="menu">
                                                                                                    <ul>
                                                                                                        ...
                                                                                                        @foreach($menu->subcategory as $row)
                                                                                                        <li>
                                                                                                            ...
                                                                                                            <ul>
                                                                                                                ...
                                                                                                                @foreach($row['childcategories'] as $childcategory)
                                                                                                                <li>
                                                                                                                    <a href="/childcategory/{{$childcategory->id}}">
